        ...
        <div class="card mb-4 p-3 shadow-sm border-primary">
            ...
            <form action="{{ url_for('add_student') }}" method="POST">
                <div class="row g-3">
                    ...
                    <div class="col-md-1"><input type="number" name="grade" class="form-control" placeholder="Grade" required></div>
        ...
        <table class="table table-striped table-bordered shadow-sm bg-white">
            ...
            <tbody>
                ...
                <tr class="{% if student.id == last_updated_id %}highlight{% endif %}">
                    ...
                    <td><input type="number" name="grade" value="{{ student.grade }}" class="form-control" required></td>
