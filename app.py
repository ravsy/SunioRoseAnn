...
students = [
    {"id": 1, "name": "Juan", "grade": 10.0, "section": "Zechariah", "age": 15, "favorite_subject": "Math"},
    {"id": 2, "name": "Maria", "grade": 9.5, "section": "Gabriel", "age": 14, "favorite_subject": "Science"}
]
...
def add_student():
    ...
    students.append({
        "id": new_id,
        "name": name,
        "grade": float(grade),  # decimal allowed
        "section": section,
        "age": int(age),
