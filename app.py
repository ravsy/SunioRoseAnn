        ...
        <table class="table table-striped table-bordered shadow-sm bg-white">
            ...
            <tbody>
                ...
                <tr class="{% if student.id == last_updated_id %}highlight{% endif %}">
                    ...
                    <td><input type="number" step="0.1" name="grade" value="{{ student.grade }}" class="form-control" required></td>
                    <td><input type="text" name="section" value="{{ student.section }}" class="form-control" required></td>
                    <td><input type="number" name="age" value="{{ student.age }}" class="form-control" required></td>
                    <td><input type="text" name="favorite_subject" value="{{ student.favorite_subject }}" class="form-control" required></td>
...
def add_student():
    ...
    favorite_subject = request.form.get("favorite_subject").strip()

    new_student = Student(name=name, grade=grade, section=section, age=age, favorite_subject=favorite_subject)
...
def edit_student(student_id):
    ...
    student.favorite_subject = request.form.get("favorite_subject").strip()
    db.session.commit()
...
if __name__ == "__main__":
    app.run(debug=True)from flask import Flask, request, redirect, url_for, flash, render_template_string
from flask_sqlalchemy import SQLAlchemy
